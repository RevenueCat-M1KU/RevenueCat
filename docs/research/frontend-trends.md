...
- **Tested, not only read.** Version 0.4.0 of Google's `@google/design.md` CLI
  ...
  [verification gate](/docs/plans/0004-guessling-product-prd-trd.md#verification-gate).
...
[plan-gate]: /docs/plans/0004-guessling-product-prd-trd.md#verification-gate
