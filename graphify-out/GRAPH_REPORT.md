# Graph Report - ax5  (2026-09-26)

## Corpus Check
- 366 files · ~893,975 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4524 nodes · 5745 edges · 317 communities (296 shown, 21 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6740cd51`
...
## Communities (317 total, 21 thin omitted)
...
### Community 14 - "consent/controller.ts"
Cohesion: 0.32
Nodes (9): ConfigPort, ConsentPorts, ConsentState, Card, consentCard(), consentWords, permissionStep(), serviceName() (+1 more)
...
Cohesion: 0.07
Nodes (35): buildGazetteer(), GazetteerBank, GazetteerFinder, normalize(), rebuildGazetteer(), rebuilding, RebuildState, runTagChecks() (+27 more)
...
Cohesion: 0.07
Nodes (38): HomeRoute(), Category, Phrase, Place, ColorName, colors, colorValues, textStyle() (+30 more)
...
Cohesion: 0.05
Nodes (71): Bank, RankingData, Reply, bank, categories, jev(), JevCall, jevLine() (+63 more)
...
Cohesion: 0.12
Nodes (17): dependencies, expo, expo-constants, expo-crypto, expo-sqlite, expo-status-bar, react-native-safe-area-context, react-native-screens (+9 more)
...
Cohesion: 0.11
Nodes (25): AssetStatus, EngineChoice, EngineId, EnginePicker, EngineState, ListenEngine, ListenEngineEvents, ListenLine (+17 more)
...
### Community 273 - "relay.ts"
Cohesion: 0.14
Nodes (15): ConfigPorts, createConfigClient(), defaultConfig, isConfig(), isRecord(), clientPorts(), databases, identityStorage() (+7 more)
...
Cohesion: 0.19
Nodes (17): Budget, fits(), isOn(), readConfig(), readPolicy(), wholeNumber(), answerLine(), deviceFor() (+9 more)
...
### Community 301 - "device.ts"
Cohesion: 0.15
Nodes (9): Address, Cached, Device, JevReply, LineReply, Terms, unlessAborted(), countInMinute() (+1 more)
...
## Knowledge Gaps
- **2987 isolated node(s):** `$schema`, `printWidth`, `singleQuote`, `semi`, `trailingComma` (+2982 more)
...
- **Why does `startingPolicy` connect `row.ts` to `worker/src/index.ts`, `consent.test.ts`, `calibration.ts`, `relay.ts`, `helpers.ts`, `score.ts`, `embeddings.ts`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `createVoiceSettings()` connect `voice-settings.ts` to `turn-context.tsx`?**
