/**
 * The words the keyword ranking drops: NLTK's English stop words without their 45 contractions, which MiniSearch's
 * tokenizer splits into fragments already here, such as "don" and "t", plus "please".
 */
